...
import Bride from '@assets/images/p-dinda-2.png';
import Groom from '@assets/images/p-indra.jpg';

import { styWrapper } from './styles';

function HelloSection({ isInvitation }) {
  const finalSubtitle = isInvitation ? '25 Juli 2021, Burza Hotel Yogyakarta' : 'Minggu, 25 Juli 2021';
          ...
          <div className="couple-wrap">
            <div className="couple-half">
              ...
              <div className="desc-groom">
                <h3 className="main-font">Catharina Mersa Lutviaana, S.I.Kom.</h3>
                <p className="parent-name parent-name__top">
                  Putri Bapak Leo Agung Kusjanadi <br />& Ibu Maria Godeliva Sri Rahayu
                </p>
              </div>
            </div>
            ...
            <div className="couple-half">
              ...
              <div className="desc-bride">
                <h3 className="main-font">Dionysius Dewaji Madyasta, S.Kom.</h3>
                <p className="parent-name">
                  Putra Bapak Eko Karsono Damianus <br />& Ibu Vincensia Sri Jotho
                </p>
              </div>
            </div>
          </div>
