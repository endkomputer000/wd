...
function GenerateLink() {
  ...
  const URL = `https://vibrant-fermi-7c7459.netlify.app?to=${encodeURIComponent(name)}`;
            ...
            <table class="table">
              ...
              <tbody>
                {data.map((d, index) => {
                  ...
                  const mapURL = `https://vibrant-fermi-7c7459.netlify.app?to=${encodeURIComponent(d.name)}${offlineInvitation}`;
                  return (
                    <tr>
                      <td>{index + 1}</td>
                      <td>{d.name}</td>
